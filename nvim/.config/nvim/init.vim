...
set fileformat=unix 
set clipboard=unnamedplus  "usting system clipboard
set ttyfast                " speed up scrolling

filetype indent on
filetype plugin on         " specific file type plugins are enabled
...
noremap k n|        "next match       replaces (n)ext
...
inoremap <C-e> <cmd>actions.move_selection_previous<cr>


" vim-xkbswitch
" needs  xkb-switch (aur) to work
let g:XkbSwitchEnabled = 1
let g:XkbSwitchNLayout = 'us(colemak)'
...
" End of MarkdownPreview settings
